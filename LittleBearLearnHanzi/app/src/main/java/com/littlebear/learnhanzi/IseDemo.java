...
public class IseDemo extends Activity implements OnClickListener {
    ...
    private EvaluatorListener mEvaluatorListener = new EvaluatorListener() {
        ...
        public void onResult(EvaluatorResult result, boolean isLast) {
            ...
            if (isLast) {
                ...
                System.out.println("****************EvaluatorListener onResult ***************");
        ...
        public void onBeginOfSpeech() {
            ...
            System.out.println("****************EvaluatorListener onBeginOfSpeech ***************");
        }
        ...
        public void onEndOfSpeech() {
            ...
            System.out.println("****************EvaluatorListener onEndOfSpeech ***************");
        }
        ...
        public void onVolumeChanged(int volume, byte[] data) {
            ...
            System.out.println("****************EvaluatorListener onVolumeChanged ***************");
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ise_demo);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.ise_start:
                ...
                System.out.println("****************IseDemo ise_start ***************");
            ...
            case R.id.ise_parse:
                ...
                System.out.println("****************IseDemo ise_parse ***************");
                break;
            case R.id.ise_stop:
                ...
                System.out.println("****************IseDemo ise_stop ***************");
                break;
            case R.id.ise_cancel: {
                ...
                System.out.println("****************IseDemo ise_cancel ***************");
                break;
            }
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        System.out.println("****************IseDemo onActivityResult ***************");
    }
    ...
    protected void onDestroy() {
        ...
        System.out.println("****************IseDemo onDestroy ***************");
    }
    ...
    private void setEvaText() {
        ...
        System.out.println("****************IseDemo setEvaText ***************");
    }
    ...
    protected void onResume() {
        ...
        System.out.println("****************IseDemo onResume ***************");
    }
...
/*		// 开放统计 移动数据统计分析
        ...
        System.out.println("****************IseDemo onPause ***************");
    }
}
